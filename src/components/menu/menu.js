    ...
    <ul className="sidebar-menu" data-widget="tree">
      ...
      <li className="active treeview menu-open">
        ...
        <ul className="treeview-menu">
          <li className={pathname == '/stock' ? "active" : null}><Link to="/stock"><i className="fa fa-circle-o" />Stock</Link></li>
          <li className={pathname == '/shop' ? "active" : null}><Link to="/shop"><i className="fa fa-circle-o" />Shop</Link></li>
          <li className={pathname == '/report' ? "active" : null}><Link to="/report"><i className="fa fa-circle-o" />Report</Link></li>
          <li className={pathname == '/transaction' ? "active" : null}><Link to="/transaction"><i className="fa fa-circle-o" />Transaction</Link></li>
        </ul>
      </li>
